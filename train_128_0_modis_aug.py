...
min_max = pd.read_csv("/explore/nobackup/people/spotter5/cnn_mapping/nbac_training/modis_global_min_max_cutoff.csv").reset_index(drop = True)
...
training_names = get_files('/explore/nobackup/people/spotter5/cnn_mapping/nbac_training/nbac_modis_subs_0_128_aug')

validation_names = pd.read_csv('/explore/nobackup/people/spotter5/cnn_mapping/nbac_training/nbac_modis_crop_0_128_validation_files.csv')['Files'].tolist()
testing_names = pd.read_csv('/explore/nobackup/people/spotter5/cnn_mapping/nbac_training/nbac_modis_crop_0_128_testing_files.csv')['Files'].tolist()
...
callbacks = [tensorflow.keras.callbacks.ModelCheckpoint(
    filepath="/explore/nobackup/people/spotter5/cnn_mapping/nbac_training/models/modis_dnbr_0_five_plus_128_2d_ds_aug.tf",
#     verbose=1,
    save_weights_only=False,
    save_best_only=True,
    monitor='val_mean_iou',
    mode = 'max'),
    tensorflow.keras.callbacks.EarlyStopping(monitor='val_mean_iou', mode = 'max', patience=5),
    tensorflow.keras.callbacks.ReduceLROnPlateau(monitor = 'val_mean_iou', mode = 'max', patience = 10, min_LR =1e-8)]
...
with strategy.scope():
    ...
    model_unet_from_scratch = models.unet_plus_2d((None, None, 1), filter_num=  [16,32,64,128,256,512,1024], #make smaller64, 128, 256, 512,[16, 32, 64, 128]
...
history = model_unet_from_scratch.fit(
 ...
 # class_weight = {0: 250, #14000  to 380000 so increase by 250
 #                    1: 1}
# model_unet_from_scratch.save("/explore/nobackup/people/spotter5/cnn_mapping/nbac_training/l8_sent_collection2_079_128.h5")
model_unet_from_scratch.save("/explore/nobackup/people/spotter5/cnn_mapping/nbac_training/models/modis_dnbr_0_five_plus_128_2d_ds_aug.tf")
...
result.to_csv("/explore/nobackup/people/spotter5/cnn_mapping/nbac_training/modis_dnbr_0_five_plus_128_2d_ds_aug.csv")
